    ...
    <div class="sidebar-body">
        ...
        <div class="admin-profile-card">
            ...
            <div class="admin-info">
                ...
                <span class="role text-warning fw-bold">
                    @if($adminRole == 'super') <i class="mdi mdi-crown"></i> Super Admin 
                    @elseif($adminRole == 'finance') <i class="mdi mdi-cash"></i> Admin Finance
                    @else <i class="mdi mdi-headset"></i> Admin CS @endif
                </span>
            </div>
        </div>
